...
dl = dataloader(scenario= 3, path="C:/Users/raphi/Nextcloud/smart_hans/AP2/Daten/auf_kopf_export", nr_taps=1, move_window_by=-10, feature_list= ["nosetip_y","nosetip_x"])
